...
RUN curl -sSL -o $CATALINA_HOME/webapps/ROOT.war https://repo1.maven.org/maven2/net/sf/aguacate/aguacate/0.4.4/aguacate-0.4.4.war \
 && echo "9b5ba0cd552959d0ca182342dddffb22fa4343e8  $CATALINA_HOME/webapps/ROOT.war" | sha1sum -c - \
