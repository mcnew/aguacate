...
RUN curl -sSL -o $CATALINA_HOME/webapps/ROOT.war https://repo1.maven.org/maven2/net/sf/aguacate/aguacate/0.4.9/aguacate-0.4.9.war \
 && echo "b79074b0ca60624b39b3edaaaafd9c31dd6899f4  $CATALINA_HOME/webapps/ROOT.war" | sha1sum -c - \
