...
RUN curl -sSL -o $CATALINA_HOME/webapps/ROOT.war https://repo1.maven.org/maven2/net/sf/aguacate/aguacate/0.4.8/aguacate-0.4.8.war \
 && echo "edcfe1886219f128d4298b6384418f6a34234f94  $CATALINA_HOME/webapps/ROOT.war" | sha1sum -c - \
